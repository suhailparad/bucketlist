...
function Dashboard({user,onLogout}){
  ...
  const tasks=useMemo(()=>buckets.flatMap(bucket=>bucket.tasks),[buckets]);const completed=tasks.filter(task=>task.completed).length;const progress=tasks.length?Math.round(completed/tasks.length*100):0;
